...
function buildToolCallingInstructions(modelId = "") {
  ...
  return [
    "",
    "## Tool Calling",
    "When you need to use a tool, you MUST output ONLY a tool call tag with valid JSON inside. Do NOT add any text before or after the tag.",
    "",
    "### Single tool call:",
    ...
    "",
    "### Rules:",
    "1. Output ONLY the vgo_tool_call tag. Nothing else.",
    "2. Do NOT use markdown code blocks (no ```).",
    "3. Do NOT explain. Just output the tag.",
