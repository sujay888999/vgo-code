...
function buildToolCallingInstructions(modelId = "") {
  ...
  if (family === "minimax") {
    return [
      ...
      "- write_file: write text to file, overwrites file (params: path, content)",
      "- append_file: append content to existing file (params: path, content)",
      ...
      "",
      "### Important: For long code files, use write_file + append_file:",
      "Step 1: write_file - write the header/imports first",
      "Step 2: append_file - add the rest of the code",
      "",
      "### Examples:",
      ...
      "</minimax:tool_call>",
      "",
      "Example 3 - Write file (for short content):",
      "<minimax:tool_call>",
      ...
      "</minimax:tool_call>",
      "",
      "Example 4 - Write and append (for long code):",
      "<minimax:tool_call>",
      "<invoke name=\"write_file\">",
      "<parameter name=\"path\">hello.py</parameter>",
      "<parameter name=\"content\">import os</parameter>",
      "</invoke>",
      "</minimax:tool_call>",
      "<minimax:tool_call>",
  ...
  return [
    ...
    "### Single tool call:",
    "先检查目录结构。",
    '<vgo_tool_call>{"name":"list_dir","arguments":{"path":"."}}</vgo_tool_call>',
    "",
    "### Multiple tool calls:",
    "先检查目录，再读取关键文件。",
...
function buildDesktopSystemPrompt(settings, sessionMeta = {}) {
  ...
  const basePrompt = [
    ...
    "10. \u5f53\u4f60\u9996\u5148\u8c03\u7528 list_dir \u540e\uff0c\u5982\u679c\u76ee\u5f55\u4e3a\u7a7a\u6216\u6587\u4ef6\u6781\u5c11\uff0c\u4e0d\u8981\u5f3a\u884c\u8bfb\u53d6 package.json\u3001tsconfig.json \u7b49\u9879\u76ee\u914d\u7f6e\u6587\u4ef6\u3002\u76f4\u63a5\u6839\u636e\u7528\u6237\u9700\u6c42\u521b\u5efa\u6587\u4ef6\u5373\u53ef\u3002",
    "11. \u5982\u679c read_file \u62a5\u9519\u6587\u4ef6\u4e0d\u5b58\u5728\uff0c\u4e0d\u8981\u91cd\u590d\u8bd5\u8bfb\u76f8\u540c\u7684\u6587\u4ef6\uff0c\u8f6c\u800c\u76f4\u63a5\u5b8c\u6210\u4efb\u52a1\u3002",
    "",
